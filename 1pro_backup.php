...
<form  name="alta" method="post" onSubmit="return validar(this)" action="guar_per.php">
    ...
    <table width="600" border="0">
      ...
      <tr>
        <td><table width="600" border="0">
          ...
          <tr>
            <td colspan="2" align="center"><input name="button2" type="button" class="botonalpha" onclick="MM_openBrWindow('','','')" value="Agregar Profesi&oacute;n" /></td>
            <td colspan="2" align="center"><input name="trabaja" type="button" class="botonalpha" onclick="MM_openBrWindow('','','')" value="Agregar Domicilio" /></td>
          </tr>
  <td class="Estilo1">Estado Civil</td>
    <td><?php 
      ...
      <table width="200">
        <tr>
          <td>
            <label>
              <input type="radio" name="estado" value="casado" id="estado_0" onclick="MM_openBrWindow('estado.php','','')" />
              Casado</label>
          </td>
        </tr>
        <tr>
          <td>
            <label>
              <input type="radio" name="estado" value="viudo" id="estado_1" />
              Viudo</label>
          </td>
        </tr>
        <tr>
          <td>
            <label>
              <input type="radio" name="estado" value="soltero" id="estado_2" />
              Soltero</label>
          </td>
        </tr>
        <tr>
          <td>
            <label>
              <input type="radio" name="estado" value="divorciado" id="estado_3" />
              Divorciado</label>
          </td>
        </tr>
      </table></td>
    ...
    <td><table width="200">
      <tr>
        <td><label>
          <input name="trabaja" type="radio" id="trabaja_1" onclick="MM_openBrWindow('','','')" value="si" />
          Si</label></td>
      </tr>
      <tr>
        <td><label>
    ...
    <td colspan="3" align="left"><div align="center">
      <input name="celular" type="button" class="botonalpha" id="celular" onclick="MM_openBrWindow('','','')" value="Agregar Celular" />
    </div></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="left"><div align="center">
      <input name="fec" type="text" disabled class="campologin" id="fec" value="<?php print "$anyo_actual/$mes_actual/$dia_actual";?>" />
    </div></td>
  </tr>
  <tr>
    <td align="right"><strong>Grupo social:</strong></td>
    <td align="left"><div align="center">
      <input name="trabaja5" type="button" class="botonalpha" id="trabaja5" onclick="MM_openBrWindow('','','')" value="Agregar Red Social" />
    </div></td>
  </tr>
        </table></td>
      </tr>
