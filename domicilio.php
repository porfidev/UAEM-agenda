...
<div id="contenedor">
	<div id="contenido">
<p class="Estilo1">No.Contacto
  <?php
$a=$_SESSION['a'];
echo "".$a."";
?>
</p>
<form  name="preguntar" method="post"  onsubmit="return validar(this)" action="guar_dom.php">
  <div align="center">
    <table width="200" border="1">
      <tr>
        <td class="Estilo1">Calle</td>
        <td class="Estilo1"><div align="center">
          <input name="calle" type="text" class="campologin" id="calle" onblur='if(this.value==&quot;&quot;) alert(&quot;llena el campo&quot;)'/>
        </div></td>
...
/>
 ...
 />
      ...
      <tr>
        ...
        <td class="Estilo1"><select name="estado" class="botonalpha" id="estado">
        ...
        <td class="Estilo1"><select name="pais" class="botonalpha" id="pais">
      ...
      <tr>
        ...
        <td class="Estilo1"><div align="center">
          <input name="trabaja3" type="button" class="botonalpha" id="trabaja3" value="Agregar Telefono" onclick="MM_openBrWindow('telefono.php','','width=600','height=300')" />
        </div></td>
        <td class="Estilo1">Representante</td>
        <td class="Estilo1"><div align="center">
          <input name="trabaja" type="button" class="botonalpha" id="trabaja" value="Agregar Representante" onclick="MM_openBrWindow('representante.php','','width=600','height=300')" />
        </div></td>
      </tr>
    </table>
  </div>
